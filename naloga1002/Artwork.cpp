...
Artwork::Artwork(std::string title, std::string description, int year, double price,const std::shared_ptr<Artist>& artist) {
...
bool Artwork::isMoreExpensive(const std::shared_ptr<Artwork>& artwork) const {
...
void Artwork::setArtist(std::shared_ptr<Artist> artist) {
    this->artist = artist;
}
